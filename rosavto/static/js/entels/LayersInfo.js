define([
    ...
    function (declare, array, lang, query, attr, Memory, Observable, xhr,
              Deferred, DeferredList, xmlParser, SimpleQueryEngine) {
        return declare('entels.LayersInfo', null, {
            _filled: false,
            ...
            _saveResourceToStore: function (resourceInfoItem, resourceType) {
                ...
                switch (resourceType) {
                    ...
                    case 'vector_layer':
                        ...
                        resource.geometry_type = resourceInfoItem.vector_layer && resourceInfoItem.vector_layer.geometry_type ?
                            resourceInfoItem.vector_layer.geometry_type :
                            null;
                        resourceSaved = parent.layers[parent.layers.push({
                            id: resource.id,
                            res: resource,
            ...
            getListLayers: function () {
                ...
                resourceLayers = SimpleQueryEngine(function(resource) {
                    return resource.type === 'postgis_layer' || resource.type === 'vector_layer';
                })(this.store.query());
